...
add("sig04", "タイムアウト", "審判",
    arm3(76, 98, 62, 128, 88, 122) + hand("front", 88, 122, 0) +
    arm3(124, 92, 142, 70, 106, 80) + hand("down", 104, 82, 180),
...
add("sig25", "ボールコンタクト(ワンタッチ)", "審判",
    arm3(76, 102, 56, 132, 76, 110) + hand("front", 76, 110, 0) +
    arm3(124, 96, 140, 76, 108, 66) + hand("down", 108, 66, 180) +
    motion_line(80, 58, 44, 64, w=5),
...
add("sig26", "ディレイウォーニングまたはディレイペナルティ", "審判",
    arm3(76, 96, 58, 72, 62, 44) + hand("front", 62, 44, -8) +
    arm3(124, 98, 110, 74, 86, 58) +
    card(74, 50, YELLOW, w=19, h=26, angle=-16),
